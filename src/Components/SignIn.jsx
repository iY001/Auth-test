...
function SignIn() {
  ...
  return (
    <>
      <div id="login-popup" className={`bg-black/50 overflow-y-auto overflow-x-hidden top-0 right-0 left-0 z-50 h-full items-center justify-center flex cursor-default fixed`} >
        <div
          id='login-form'
          className={`relative p-4 w-full max-w-md h-full md:h-auto z-40 transition-all duration-500 ${showLoginForm ? 'top-0' : 'top-[-800px]'
            }`}
        >
          <div className="relative bg-white rounded-lg shadow z-40">
            ...
            <div className="p-5">
              ...
              <form onSubmit={handleSubmit} className="w-full">
                <input ref={emailRef} name="email" type="email" autoComplete="email" required className="block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm outline-none placeholder:text-gray-400 focus:ring-2 focus:ring-black focus:ring-offset-1" placeholder="Email Address" />
                <input ref={passwordRef} name="password" type="password" autoComplete="current-password" required className="mt-2 block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm outline-none placeholder:text-gray-400 focus:ring-2 focus:ring-black focus:ring-offset-1" placeholder="Password" />
                <p className="mb-3 mt-2 text-sm text-gray-500">
                  <a href="/forgot-password" className="text-[#c13c07] hover:text-[#f43c09a7]">Reset your password?</a>
                </p>
                <button type="submit" className="inline-flex w-full items-center justify-center rounded-lg bg-[#f43c09a7] p-2 py-3 text-sm font-medium text-white outline-none focus:ring-2 focus:ring-black focus:ring-offset-1 disabled:bg-gray-400">
                  Continue
                </button>
              ...
              <div className="mt-6 text-center text-sm text-slate-600">
                ...
                <a href="/signup" className="font-medium text-[#f43c09a7]">Sign up</a>
              </div>
            </div>
